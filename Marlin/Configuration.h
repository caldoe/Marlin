...
#define STRING_CONFIG_H_AUTHOR "(caldoe, Ender 5 Plus)" // Who made the changes.
...
// Used for SKR14Turbo USB Connection to host-pC
#define SERIAL_PORT -1

// Used for SKR14Turbo Screen-controls
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  14.72,  14.72 }
    #define DEFAULT_Ki_LIST {   0.89,   0.89 }
    #define DEFAULT_Kd_LIST {  61.22,  61.22 }
  #else
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 101.24 }
